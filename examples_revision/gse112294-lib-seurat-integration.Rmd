...
```{r}
write.csv(obj@reductions$pca@cell.embeddings, '../output-embeddings/gse112294_lib_seurat.csv')
write.csv(obj@reductions$umap@cell.embeddings, '../output-embeddings/gse112294_lib_seurat_umap.csv')
```