...
png("../figures/s5c.png", width=1200, height=750, res=300)
plt <- VlnPlot(subobj, "monocle3_pseudotime", group.by = 'sample') + NoLegend()
...
png("../figures/s5d.png", width=1050, height=750, res=300)
print(fig)
dev.off()
fig
```