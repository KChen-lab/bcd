...
obj <- FindVariableFeatures(obj, selection.method = "vst", nfeatures = 150, verbose=FALSE)

obj <- ScaleData(obj, features = VariableFeatures(obj), verbose=FALSE)
obj <- RunPCA(obj, features = rownames(mat), npcs = 30, verbose=FALSE)
...
ggsave("sim_pca_sample.png", height=12, width=18, dpi = 100)
```

```{r}
DimPlot(obj, reduction = "umap", group.by = "label", label.size = 5,  pt.size = 1) +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank(),
        text=element_text(size=18))
ggsave("sim_pca_label.pdf")

DimPlot(obj, reduction = "umap", group.by = "label", label.size = 10,  pt.size = 1) +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank(),
        text=element_text(size=30))
ggsave("sim_pca_label.png", height=12, width=18, dpi = 100)
```
...
obj <- RunALT(object = obj, feature.unwanted = "sample", dims.use = 1:30, reduction.use = "pca", 
              feature.time.dict = feature.time.dict, reduction.name = "alt", reg = 1, reduction.key = "ALT_")

obj <- RunUMAP(obj, reduction = "alt", dims = 1:30, verbose=FALSE, reduction.name = "umap2")

DimPlot(obj, reduction = "umap2", group.by = "sample")
```

```{r}
DimPlot(obj, reduction = "umap2", group.by = "label", label = T, repel = T, label.size = 5,  pt.size = 1) +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank(),
        text=element_text(size=18))
ggsave("sim_alt_label.pdf")

DimPlot(obj, reduction = "umap2", group.by = "label", label = T, repel = T, label.size = 10,  pt.size = 1) +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank(),
        text=element_text(size=30))
ggsave("sim_alt_label.png", height=12, width=18, dpi = 100)
```

```{r}
DimPlot(obj, reduction = "umap2", group.by = "sample", label.size = 5,  pt.size = 1) +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank(),
        text=element_text(size=18))
ggsave("sim_alt_sample.pdf")

DimPlot(obj, reduction = "umap2", group.by = "sample", label.size = 10,  pt.size = 1) +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank(),
        text=element_text(size=30))
ggsave("sim_alt_sample.png", height=12, width=18, dpi = 100)
```

```{r}
write.csv(obj@meta.data, '../output-embeddings/sim_eq_metadata.csv')

write.csv(obj@reductions$pca@cell.embeddings, '../output-embeddings/sim_eq_pca.csv')
write.csv(obj@reductions$alt@cell.embeddings, '../output-embeddings/sim_eq_bcd.csv')

write.csv(obj@reductions$umap@cell.embeddings, '../output-embeddings/sim_eq_pca_umap.csv')
write.csv(obj@reductions$umap2@cell.embeddings, '../output-embeddings/sim_eq_bcd_umap.csv')
```
