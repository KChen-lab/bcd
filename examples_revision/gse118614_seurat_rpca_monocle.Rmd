...
```{r}
obj <- readRDS("../output-embeddings/gse118614_seurat_rpca.RDS")
```
...
png("../figures/s5g.png", width=1200, height=750, res=300)
...
df <- data.frame(pseudotime=subobj$monocle3_pseudotime, 
                 Nfia=subobj@assays$integrated@data['ENSMUSG00000028565', ],
                 Nfib=subobj@assays$integrated@data['ENSMUSG00000008575', ],
                 Nfic=subobj@assays$integrated@data['ENSMUSG00000055053', ])
...
png("../figures/s5h.png", width=1050, height=750, res=300)
print(fig)
dev.off()
fig
```