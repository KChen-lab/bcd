...
```{r}
write.csv(obj@reductions$pca@cell.embeddings, '../output-embeddings/gse112294_lib_seurat_rpca.csv')
write.csv(obj@reductions$umap@cell.embeddings, '../output-embeddings/gse112294_lib_seurat_rpca_umap.csv')
```