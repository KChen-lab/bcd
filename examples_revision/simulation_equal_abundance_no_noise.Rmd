...
```{r}
# write.csv(obj@meta.data, '../output-embeddings/sim_metadata.csv')
write.csv(obj@reductions$pca@cell.embeddings, '../output-embeddings/sim_eq_pca_nonoise.csv')
write.csv(obj@reductions$umap@cell.embeddings, '../output-embeddings/sim_eq_pca_nonoise_umap.csv')
```
