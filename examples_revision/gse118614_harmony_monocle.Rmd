...
```{r}
obj <- readRDS("../output-embeddings/gse118614_harmony.RDS")
```
...
png("../figures/s5_harmony_a.png", width=1200, height=750, res=300)
...
png("../figures/s5_harmony_b.png", width=1050, height=750, res=300)
print(fig)
dev.off()
fig
```