...
ggsave("covid_seurat_rpca_label.pdf")
...
ggsave("covid_seurat_rpca_label.png", height=12, width=18, dpi = 100)
```

```{r}
saveRDS(obj, "../output-embeddings/gse145926_seurat_rpca.RDS")
```

```{r}
write.csv(obj@reductions$pca@cell.embeddings, '../output-embeddings/gse145926_seurat_rpca.csv')
write.csv(obj@reductions$umap@cell.embeddings, '../output-embeddings/gse145926_seurat_rpca_umap.csv')
```
