...
```{r}
pca_metric <- intCriteria(obj@reductions$pca@cell.embeddings[, 1:30], 
                          as.integer(as.factor(obj$label)), 
                          c("Silhouette"))
pca_metric
```

```{r}
alt_metric <- intCriteria(obj@reductions$alt@cell.embeddings[, 1:30], 
                          as.integer(as.factor(obj$label)), 
                          c("Silhouette"))
alt_metric 
```
